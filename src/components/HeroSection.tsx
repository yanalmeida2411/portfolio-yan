...
export default function HeroSection() {
  ...
  return (
    ...
    >
      <img src="/gif-bg.gif" alt="Imagem de fundo" className="absolute inset-0 w-full h-full opacity-10" />
      <div className="max-w-4xl text-center space-y-6 z-10">
        ...
        <p className="text-gray-700 max-w-xl md:text-lg mx-auto leading-relaxed">
          ...
          integrando soluções completas com Node.js, MySQL, PostgreSQL, utilizando as linguagens Java, Golang, JavaScript e TypeScript.
        </p>

        <button 
          onClick={() => scrollToSection('contato')}
          className="inline-block mt-8 bg-[#006080] hover:bg-gray-400 text-white px-10 py-4 rounded-xl text-xl font-semibold shadow-lg transition
